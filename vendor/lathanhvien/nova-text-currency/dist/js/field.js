...
Nova.booting(function (Vue, router) {
    Vue.component('index-NovaTextCurrency', __webpack_require__(9));
    Vue.component('detail-NovaTextCurrency', __webpack_require__(12));
    Vue.component('form-NovaTextCurrency', __webpack_require__(15));
});
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        showSign: function showSign(code) {
            return '&#' + code + ';';
        },
    ...
    [
      _c("template", { slot: "field" }, [
        ...
        _c("p", { staticClass: "py-1" }, [
          _vm._v(_vm._s(_vm.showValue(this.value)))
        ])
      ])
    ],
    2
